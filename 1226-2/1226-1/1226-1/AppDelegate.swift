...
class AppDelegate: UIResponder, UIApplicationDelegate, SKMapVersioningDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        //SKMAps
        let apiKey = "bb8e8ac7466d11512d621bd9574b45673597ebd22d3251b03be550403d386b53"
        let initSettings: SKMapsInitSettings = SKMapsInitSettings()
        initSettings.mapDetailLevel = SKMapDetailLevel.full
        
        SKMapsService.sharedInstance().initializeSKMaps(withAPIKey: apiKey, settings: initSettings)
    ...
    lazy var persistentContainer: NSPersistentContainer = {
        ...
        */
        let container = NSPersistentContainer(name: "_226_1")
